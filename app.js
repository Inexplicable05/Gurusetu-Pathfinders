// Alumni Social Media App JavaScript

document.addEventListener('DOMContentLoaded', function() {
    // Check authentication first
    if (!window.authSystem) {
        // If auth system isn't loaded yet, wait for it
        setTimeout(() => {
...
function checkAuthAndInitialize() {
    ...
    if (!authSystem.isLoggedIn()) {
        // Redirect to login quickly (no loader)
...
function setupUserInterface() {
    ...
    if (donationSection) {
        // Always clear any inline styles applied previously
        donationSection.style.removeProperty('display');
        if (isStudent) {
            donationSection.classList.add('md:hidden'); // hide on desktop for students
        } else {
            donationSection.classList.remove('md:hidden'); // allow md:flex from markup to take effect
        }
    }
...
const opportunities = [
    {
        ...
        type: "Full-time",
        location: "Remote",
        // Converted to INR, but hidden in landing previews
        salary: "₹60–90 LPA",
        posted: "2 days ago",
        category: "job"
    },
    ...
    {
        title: "Backend Engineer - Series A Startup",
...
const events = [
    {
        title: "Alumni Networking Gala 2025",
        date: "2025-10-15",
...
function populateFollowing() {
    ...
    const followingContainer = containers[1]; // Second container is Following
...
function populateOpportunities() {
    const containers = document.querySelectorAll('.bg-white.rounded-lg.border.border-gray-200 .p-4.space-y-3');
    const opportunitiesContainer = containers[2]; // Third container is Opportunities
    ...
    opportunities.forEach(opportunity => {
        ...
        const categoryColors = {
            job: 'from-blue-400 to-blue-600',
            freelance: 'from-green-400 to-green-600',
            workshop: 'from-purple-400 to-purple-600',
            internship: 'from-orange-400 to-orange-600'
        };
    ...
    const previousEvents = [
        {
            ...
            image: "https://images.unsplash.com/photo-1511578314322-379afb476865?w=300&h=150&q=80&fit=crop"
        },
        {
            title: "Tech Innovation Summit",
            image: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=300&h=150&q=80&fit=crop"
        },
        {
            title: "Career Fair 2024",
            image: "https://images.unsplash.com/photo-1556761175-b413da4baf72?w=300&h=150&q=80&fit=crop"
        }
    ];
    ...
    const sidebarEvents = [
        {
            ...
            maxAttendees: 150,
            isInterested: false,
            image: "https://images.unsplash.com/photo-1511578314322-379afb476865?w=80&h=60&q=80&fit=crop"
        },
        {
            id: 2,
            ...
            maxAttendees: 80,
            isInterested: true,
            image: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=80&h=60&q=80&fit=crop"
        },
        {
            id: 3,
            ...
            maxAttendees: 500,
            isInterested: true,
            image: "https://images.unsplash.com/photo-1556761175-b413da4baf72?w=80&h=60&q=80&fit=crop"
        }
    ];
...
function populateEvents() {
    const containers = document.querySelectorAll('.bg-white.rounded-lg.border.border-gray-200 .p-4.space-y-3');
    const eventsContainer = containers[3]; // Fourth container is Events
    ...
    events.forEach(event => {
        ...
        const categoryColors = {
            networking: 'from-blue-400 to-blue-600',
            educational: 'from-green-400 to-green-600',
            competition: 'from-red-400 to-red-600',
            career: 'from-purple-400 to-purple-600',
            mentorship: 'from-orange-400 to-orange-600'
        };
        
        const categoryTextColors = {
            networking: 'text-blue-700 bg-blue-100 border-blue-200',
            educational: 'text-green-700 bg-green-100 border-green-200',
            competition: 'text-red-700 bg-red-100 border-red-200',
            career: 'text-purple-700 bg-purple-100 border-purple-200',
            mentorship: 'text-orange-700 bg-orange-100 border-orange-200'
        };
...
function setupEventListeners() {
    ...
    // Donation button interaction (select by class, not label)
...
function createPost(content) {
    ...
    const newPost = {
        author: "You",
        type: "student", // or alumni based on user type
        avatar: "YU",
        time: "Just now",
        content: content,
        image: null,
    ...
    postElement.innerHTML = `
        <div class="p-6 pb-4">
            <div class="flex items-start space-x-4">
                <div class="w-12 h-12 bg-gradient-to-br from-blue-200 to-indigo-300 rounded-full flex items-center justify-center text-white font-semibold text-sm transition-all duration-300 hover:shadow-lg hover:scale-110">
                    ${newPost.avatar}
                </div>
                <div class="flex-1">
                    <div class="flex items-center space-x-2 mb-2">
...
// Number animation for banner stats
...
class NotificationManager {
        ...
        this.notifications = [
            {
                ...
                message: "Spring Networking Mixer is tomorrow at 6:00 PM",
                type: "event",
                time: "2 hours ago",
                read: false
            },
            ...
            },
            {
                ...
                message: "New scholarship opportunities available for students",
                type: "scholarship",
                time: "3 days ago",
                read: true
            }
    ...
    createNotificationItem(notification) {
        const iconClass = {
            event: 'fa-calendar-alt text-blue-500',
            connection: 'fa-user-plus text-green-500',
            scholarship: 'fa-graduation-cap text-purple-500'
